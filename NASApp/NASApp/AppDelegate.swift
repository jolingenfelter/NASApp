...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    */
    ...
    static let NASABackgroundColor = UIColor(red: 28/255, green: 22/255, blue: 54/255, alpha: 1)
    static let NASABarColor = UIColor(red: 17/255, green: 14/255, blue: 34/255, alpha: 1)
